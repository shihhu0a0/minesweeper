...
class Cell:
    ...
    def left_click_actions(self, event):
        if self.is_mine:
            ...
            if Cell.cell_count == settings.MINES_COUNT:
                os.system(
                    """osascript -e 'Tell application "System Events" to display dialog "Congradulations! You won the game!" with title "Game Over"'"""
                )
                sys.exit()
        # Cancel Left and Right clock events if cell is already opened:
    ...
    def show_mine(self):
        ...
        os.system(
            """osascript -e 'Tell application "System Events" to display dialog "You clicked on a mine!" with title "Game Over"'"""
        )
        sys.exit()
